...
const insertUser = async ({ userId, stripeId, username, email, avatarUrl }) => {
    ...
    const COLUMNS = 'user_id, cookie_id, stripe_id, username, email, avatar_url, created, last_login'
    const VALUES = [userId, uuidv4(), stripeId, username, email, avatarUrl, new Date().getTime(), new Date().getTime()]

    if (await client.query(
        `INSERT INTO users (${COLUMNS}) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
        VALUES
